...
import { fetchStaff } from '../hooks/axiosApis';
...
const EditStaff = () => {
	...
	const { data, isLoading, error } = useQuery({
		queryKey: ['users', 'staffs', id],
		queryFn: () => fetchStaff({ user, id }),
	});
	...
	const handleAddStaff = async (e) => {
		...
		try {
			...
			setRole('');
			setIsLoading(false);
			console.log('Field updated successful:', response.data);
		...
		<>
			<main className="body-content px-8 py-8 bg-slate-100">
				<div className="page-title mb-7">
					<h3 className="mb-0 text-4xl">Edit Staff</h3>
				</div>
